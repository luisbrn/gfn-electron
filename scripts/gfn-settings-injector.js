...
function createSettingsButton() {
  ...
  settingsButton.addEventListener('mouseenter', () => {
    settingsButton.style.background = 'rgba(0, 212, 170, 1)';
    settingsButton.style.transform = 'translateY(-2px)';
    settingsButton.style.boxShadow = '0 6px 16px rgba(0, 0, 0, 0.4)';
  });

  settingsButton.addEventListener('mouseleave', () => {
    settingsButton.style.background = 'rgba(0, 212, 170, 0.9)';
...
function createSettingsModal() {
  ...
  modalContent.innerHTML = `
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px;">
      <h2 style="color: #00d4aa; margin: 0; font-size: 24px;">Discord Rich Presence Settings</h2>
    ...
    <div style="margin-bottom: 25px;">
      ...
      <input type="text" id="discord-client-id" placeholder="Enter your Discord Application Client ID" 
             style="width: 100%; padding: 12px; background: #2a2d2f; border: 2px solid #3a3d3f; border-radius: 8px; color: #fff; font-size: 16px;">
    </div>
    ...
    <div style="display: flex; gap: 15px;">
      <button id="save-settings" style="flex: 1; padding: 12px; background: #00d4aa; color: #1a1d1f; border: none; border-radius: 8px; font-weight: 600; cursor: pointer;">Save Settings</button>
      <button id="test-connection" style="flex: 1; padding: 12px; background: #3a3d3f; color: #fff; border: none; border-radius: 8px; font-weight: 600; cursor: pointer;">Test Connection</button>
    </div>
